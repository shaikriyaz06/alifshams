      ...
      <section className="relative h-[800px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Conduct risk assessments, build secure access control, and implement threat detection
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Our comprehensive cybersecurity approach protects your organization from evolving threats while ensuring regulatory compliance and business continuity.
              </p>
            </div>
          </div>
        </div>
